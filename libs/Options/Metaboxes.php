	...
	trait Metaboxes {
		...
		public function nebula_main_apis_metabox($nebula_options){
			?>
				...
				<div class="form-group mb-2">
					<label for="hubspot_api">Index Now</label>

					<div class="form-group">
						<input type="hidden" name="nebula_options[index_now]" value="<?php echo $nebula_options['index_now']; ?>">
						<input id="index_now" class="sync-checkbox" value="1" type="checkbox" <?php checked('1', !empty($nebula_options['index_now'])); ?>><label for="index_now">Enable Index Now</label>
						...
						<p class="option-keywords">seo update services indexnow.org index now</p>
					</div>

					<div class="input-group" dependent-or="index_now">
						<div class="input-group-text">Index Now Key</div>
						...
						<p class="dependent-note hidden">This option is dependent on Index Now being enabled.</p>
					</div>
				</div>
