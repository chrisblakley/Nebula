...
*/
		...
		public static function escape($str, $context = 'html_attr'){
			switch ( $context ){
				case 'html':
					return self::output_html($str);
				case 'attr':
				case 'html_attr':
					return self::output_attr($str);
				case 'url':
					return self::output_url($str);
				default:
					return '';
			}
		}
		...
		/**
		 * Escape arbitrary data so that it's safe to output inside of an HTML tag. Uses HTML Purifier.
		 *
		 * @param string $str
		 ...
		 * @throws Exception
		 */
		public static function output_html($str, $allowHtml = false){
			if ( $allowHtml ){
				self::purify($str);
			}
			return self::output_attr($str);
		 ...
		 * Usage:
		 *
		 *     echo '<div data-foo="' . nebula()->attr($unsafeString) . '">';
		 *
		 * @param string $str
		 * @return string
		 */
		public static function output_attr($str){
		 ...
		 * @return string
		 */
		public static function output_url($str){
