...
if ( !trait_exists('Visitors') ){
    trait Visitors {
        ...
        public function admin_page(){
            ...
            $visitors_table_name = $this->visitors_table_name();

            $all_visitors_data_head = $wpdb->get_results("SHOW columns FROM $visitors_table_name"); //Get the column names from the primary table
            $all_visitors_data_head = (array) $all_visitors_data_head;
            $all_visitors_data = $wpdb->get_results("SELECT * FROM $visitors_table_name"); //Get all data from the data table
        ...
        public function admin_detail(){
            ...
            $visitors_data_table_name = $this->visitors_data_table_name();

            $this_user_data = $wpdb->get_results("SELECT id, label, value FROM $visitors_data_table_name WHERE nebula_id = '" . sanitize_text_field($_POST['data']) . "' ORDER BY id");
        ...
        public function ajax_similar_visitors(){
            ...
            $query = "SELECT DISTINCT($visitors_table_name.nebula_id), $visitors_table_name.* FROM $visitors_data_table_name JOIN $visitors_table_name ON $visitors_table_name.nebula_id = $visitors_data_table_name.nebula_id WHERE ($visitors_data_table_name.label = 'all_ip_addresses' AND $visitors_data_table_name.value LIKE '%" . $ip_address . "%') OR ($visitors_data_table_name.label = 'ip_address' AND $visitors_data_table_name.value LIKE '%" . $ip_address . "%')";
            if ( $_POST['similar'] == 'ip_useragent' ){
                $query = "SELECT DISTINCT($visitors_table_name.nebula_id), $visitors_table_name.* FROM $visitors_data_table_name JOIN $visitors_table_name ON $visitors_table_name.nebula_id = $visitors_data_table_name.nebula_id WHERE (($visitors_data_table_name.label = 'all_ip_addresses' AND $visitors_data_table_name.value LIKE '%" . $ip_address . "%') OR ($visitors_data_table_name.label = 'ip_address' AND $visitors_data_table_name.value LIKE '%" . $ip_address . "%')) AND $visitors_table_name.user_agent = '" . $user_agent . "'";
            }
        ...
        public function ajax_manual_delete_visitor(){
            ...
            $manual_delete = $wpdb->query($wpdb->prepare("DELETE FROM $visitors_table_name WHERE nebula_id = %s", $nebula_id)); //Associated data in nebula_visitors_data will cascade delete
        ...
        public function ajax_manual_remove_noscore(){
            ...
            $manual_delete = $wpdb->query($wpdb->prepare("DELETE FROM $visitors_table_name WHERE lead_score <= %d", 0)); //Associated data in nebula_visitors_data will cascade delete
        ...
        public function ajax_drop_nv_table(){
            ...
            $remove_nv_table = $wpdb->query("DROP TABLE $visitors_data_table_name");
            $remove_nv_table = $wpdb->query("DROP TABLE $visitors_table_name");
        ...
        public function visitors_table_name() {
            global $wpdb;

            return apply_filters( 'nebula_visitors_table_name', $wpdb->prefix . 'nebula_visitors' );
        }

        public function visitors_data_table_name() {
            global $wpdb;

            return apply_filters( 'nebula_visitors_data_table_name', $wpdb->prefix . 'nebula_visitors_data' );
        }
        ...
        public function create_tables(){
            ...
            $visitors_table = $wpdb->query("SHOW TABLES LIKE '$visitors_table_name'"); //DB Query here
            if ( empty($visitors_table) ){
                require_once( ABSPATH . 'wp-admin/includes/upgrade.php' );

                $create_primary_table_sql = "CREATE TABLE $visitors_table_name (
                ...
                $create_data_table_sql = "CREATE TABLE $visitors_data_table_name (
                    id INT(11) NOT NULL AUTO_INCREMENT,
                    nebula_id VARCHAR(255),
                    label VARCHAR(255),
                    value LONGTEXT,
                    ...
                    CONSTRAINT fk_nebula_visitors_nebula_id FOREIGN KEY (nebula_id) REFERENCES $visitors_table_name (nebula_id) ON DELETE CASCADE
                )
                ENGINE = InnoDB;"; //DB Query here
            ...
            if ( nebula()->option('visitors_db') ){
                ...
                if ( empty($last_session_id) ){ //If the nebula_id is not in the DB already, treat it as a new user
                    ...
                    if ( strpos(nebula()->ga_parse_cookie(), '-') !== false ){ //If GA CID was generated by Nebula
                        global $wpdb;
                        $unique_new_visitor = $wpdb->get_results("SELECT * FROM $visitors_table_name WHERE ip_address = '" . sanitize_text_field($_SERVER['REMOTE_ADDR']) . "' AND user_agent = '" . sanitize_text_field($_SERVER['HTTP_USER_AGENT']) . "'");
        ...
        public function generate_nebula_id($force=null){
            ...
            if ( nebula()->option('visitors_db') ){
                if ( empty($force) ){
                    ...
                    $nebula_id_from_matching_ga_cid = $wpdb->get_results($wpdb->prepare("SELECT nebula_id FROM $visitors_table_name WHERE ga_cid = '%s'", ga_parse_cookie())); //Check if the ga_cid exists, and if so use THAT nebula_id again
        ...
        public function visitors_create_missing_columns($all_data){
            if ( nebula()->option('visitors_db') ){
                ...
                if ( !empty($needed_columns) ){
                    ...
                    $alter_query = "ALTER TABLE $visitors_table_name ";
        ...
        */
        ...
        public function is_returning_visitor(){
            ...
            if ( nebula()->option('visitors_db') ){
                ...
                $unique_new_visitor = $wpdb->get_results("SELECT ga_cid FROM $visitors_table_name WHERE (ip_address = '" . sanitize_text_field($_SERVER['REMOTE_ADDR']) . "' AND user_agent = '" . sanitize_text_field($_SERVER['HTTP_USER_AGENT']) . "') OR fingerprint LIKE '%" . sanitize_text_field($this->fingerprint()) . "%'"); //DB Query here
                if ( !empty($unique_new_visitor) ){
        ...
        public function get_previous_nebula_id_by_ga_cid(){
            if ( nebula()->option('visitors_db') ){
                ...
                $nebula_id_from_matching_ga_cid = $wpdb->get_results($wpdb->prepare("SELECT nebula_id FROM $visitors_table_name WHERE ga_cid = '%s'", ga_parse_cookie())); //DB Query here.
                if ( !empty($nebula_id_from_matching_ga_cid) ){
        ...
        public function get_all_visitor_data($storage_type=false, $alt_nebula_id=false){
            if ( nebula()->option('visitors_db') ){
                ...
                if ( $storage_type != 'cache' ){
                    ...
                    $all_visitor_db_data = $wpdb->get_results("SELECT id, label, value FROM $visitors_data_table_name WHERE nebula_id = '" . sanitize_text_field($nebula_id) . "' ORDER BY id"); //DB Query here
        ...
        public function get_visitor_data($column){ //@TODO "Nebula" 0: Update to allow multiple datapoints to be accessed in one query.
            if ( nebula()->option('visitors_db') ){
                ...
                if ( !empty($nebula_id) && !empty($column) ){
                    ...
                    $requested_data = $wpdb->get_results($wpdb->prepare("SELECT " . $column . " FROM $visitors_table_name WHERE nebula_id = '%s'", $nebula_id));
        ...
        public function send_all_to_cache_and_db($all_data, $alt_nebula_id=false){ //This does like 4 db queries...
            if ( nebula()->option('visitors_db') ){
                ...
                $updated_primary_table = $wpdb->update($visitors_table_name, $this->prep_primary_table_for_db($all_data), array('nebula_id' => $nebula_id)); //DB Query here
                ...
                $update_query = "UPDATE $visitors_data_table_name SET value = CASE";
        ...
        public function insert_visitor($data=array(), $alt_nebula_id=false){
            if ( nebula()->option('visitors_db') && !empty($data) ){
                ...
                $inserted_primary_table = $wpdb->replace($visitors_table_name, $prepped_primary_data); //Insert a row with all the default (and passed) sanitized values. DB Query here
                ...
                //Build rows
                $built_insert_query = "INSERT IGNORE INTO $visitors_data_table_name (nebula_id, label, value) VALUES";
        ...
        */
        ...
        public function similar_to_known($specific=false, $storage_type=false, $alt_nebula_id=false){
            if ( nebula()->option('visitors_db') ){
                ...
                $query = "SELECT DISTINCT($visitors_table_name.nebula_id), $visitors_table_name.* FROM $visitors_data_table_name JOIN $visitors_table_name ON $visitors_table_name.nebula_id = $visitors_data_table_name.nebula_id WHERE $visitors_table_name.is_known = '1' AND (($visitors_data_table_name.label = 'ip_address' AND $visitors_data_table_name.value = '" . sanitize_text_field($all_visitor_data['ip_address']) . "') OR ($visitors_data_table_name.label = 'all_ip_addresses' AND $visitors_data_table_name.value = '" . sanitize_text_field($all_visitor_data['ip_address']) . "'))";
                if ( !empty($specific) ){
                    $query = "SELECT DISTINCT($visitors_table_name.nebula_id), $visitors_table_name.* FROM $visitors_data_table_name JOIN $visitors_table_name ON $visitors_table_name.nebula_id = $visitors_data_table_name.nebula_id WHERE $visitors_table_name.is_known = '1' AND (($visitors_data_table_name.label = 'ip_address' AND $visitors_data_table_name.value = '" . sanitize_text_field($all_visitor_data['ip_address']) . "') OR ($visitors_data_table_name.label = 'all_ip_addresses' AND $visitors_data_table_name.value = '" . sanitize_text_field($all_visitor_data['ip_address']) . "')) AND $visitors_table_name.user_agent = '" . sanitize_text_field($all_visitor_data['user_agent']) . "'";
                }
        ...
        public function remove_expired($force=false){
            if ( nebula()->option('visitors_db') ){
                ...
                if ( empty($nebula_visitor_remove_expired) || !empty($force) || nebula()->is_debug() ){
                    ...
                    $removed_visitors = $wpdb->query($wpdb->prepare("DELETE FROM $visitors_table_name WHERE last_modified_on < %d AND is_known = %s AND lead_score < %d", $expiration_length, '0', 100)); //DB Query here
        ...
        public function visitors_existing_columns(){
            ...
            return $wpdb->get_col("SHOW COLUMNS FROM $visitors_table_name", 0); //Returns an array of current table column names
        }
        ...
        public function check_if_known($send_to_hubspot=true){
            if ( nebula()->option('visitors_db') ){
                ...
                $known_visitor = $wpdb->get_results("SELECT * FROM $visitors_table_name WHERE nebula_id LIKE '" . $nebula_id . "' AND (email_address REGEXP '.+@.+\..+' OR hubspot_vid REGEXP '^\d+$')");
