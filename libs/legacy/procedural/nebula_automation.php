...
if ( is_admin_page() && is_dev(true) || current_user_can('manage_options') ){
	/*
		Until there is support for Required, Recommended, AND Optional plugins:
		When updating the class file (in the /inc/vendor/ directory, be sure to edit the text on the following function to be 'Recommended' and 'Optional' in the installation table:
