...
if ( !trait_exists('Assets') ){
	trait Assets {
		...
		public function register_scripts(){
			...
			wp_register_style('nebula-bootstrap', 'https://cdn.jsdelivr.net/npm/bootstrap@5.1.2/dist/css/bootstrap.min.css', null, '5.1.2', 'all');
			...
			$this->register_script('nebula-bootstrap', 'https://cdn.jsdelivr.net/npm/bootstrap@5.1.2/dist/js/bootstrap.bundle.min.js', array('defer', 'crossorigin'), array('jquery-core'), '5.1.2', true);
