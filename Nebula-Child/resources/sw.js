...
var CACHE_NAME = 'nebula-nebula-child-76767'; //Wednesday, August 9, 2017 12:43:33 PM
...
function needNetworkRetrieval(request){
	...
	var substrings = ['chrome-extension://', '/wp-login.php', '/wp-admin', 'analytics', 'customize.php'];
