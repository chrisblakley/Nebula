...
var CACHE_NAME = 'nebula-nebula-child-41845'; //Wednesday, September 13, 2017 11:17:59 AM
...
function needNetworkRetrieval(request){
	...
	var substrings = ['chrome-extension://', '/wp-login.php', '/wp-admin', 'analytics', 'customize.php', 'customize_', 'no-cache'];
