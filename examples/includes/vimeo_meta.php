		...
		<div class="container">
			<div class="row">
				<div class="four columns">
					<a href="<?php echo $GLOBALS['vimeo_meta']['url']; ?>" target="_blank"><img src="<?php echo $GLOBALS['vimeo_meta']['thumbnail']; ?>" width="100"/></a>
				</div><!--/columns-->
				<div class="twelve columns">
						<a href="<?php echo $GLOBALS['vimeo_meta']['url']; ?>" target="_blank"><?php echo $GLOBALS['vimeo_meta']['title']; ?></a> <span style="font-size: 12px;">(<?php echo $GLOBALS['vimeo_meta']['duration']; ?>)</span>
						<span style="display: block; font-size: 12px; line-height: 18px;">
							by <?php echo $GLOBALS['vimeo_meta']['user']; ?><br/>
							<?php echo $GLOBALS['vimeo_meta']['description']; ?>
						</span>
				</div><!--/columns-->
			</div><!--/row-->
		</div><!--/container-->
