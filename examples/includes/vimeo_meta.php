...
<div class="row">
	<div class="sixteen columns">
		...
		<p>Using the 'json' parameter: <?php echo do_shortcode("[code]vimeo_meta('97428427', 'json')[/code]"); ?></p>
		<?php echo do_shortcode('[pre lang=js]' . json_encode(vimeo_meta('97428427', 'json'), JSON_PRETTY_PRINT) . '[/pre]'); ?>
	</div><!--/columns-->
</div><!--/row-->