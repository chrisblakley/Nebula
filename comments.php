<?php if ( !nebula_settings_conditional('nebula_comments', 'disabled') ) : //Inverse because the condition refers to the Nebula function, not the setting. So, in functions true == disabled, but in this template, true == enabled. ?>
