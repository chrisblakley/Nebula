...
class Codebird
{
    ...
    private function _sha1($data)
    {
        ...
        return base64_encode(hash_hmac('sha1', $data, self::$_oauth_consumer_secret . '&' //@TODO "Nebula" 0: Replace base64_encode with an equivilent
    ...
    {
        if (! function_exists('curl_init')) { //@TODO "Nebula" 0: use WP_Filesystem methods instead of curl_init
        ...
        $ch  = false;
        if ($httpmethod == 'GET') {
            $ch = curl_init($this->_sign($httpmethod, $url, $params)); //@TODO "Nebula" 0: use WP_Filesystem methods instead of curl_init
        } else {
            if ($multipart) {
            ...
            $ch = curl_init($url); //@TODO "Nebula" 0: use WP_Filesystem methods instead of curl_init
        ...
        $reply      = curl_exec($ch); //@TODO "Nebula" 0: use WP_Filesystem methods instead of curl_exec
