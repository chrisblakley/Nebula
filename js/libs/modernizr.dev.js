...
Modernizr.addTest("supports","CSSSupportsRule" in window);// https://github.com/Modernizr/Modernizr/issues/572
...
Modernizr.addTest('getusermedia', !!Modernizr.prefixed('getUserMedia', navigator));Modernizr.addTest('fullscreen',function(){
...
// defer script
// By Theodoor van Donge
Modernizr.addTest('scriptdefer', 'defer' in document.createElement('script'));// async script
// By Theodoor van Donge
