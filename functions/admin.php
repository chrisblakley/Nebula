...
if( !class_exists( 'Nebula_Admin' ) ) {
    ...
    class Nebula_Admin {
        ...
        public function todo_metabox(){
            wp_add_dashboard_widget('todo_manager', 'To-Do Manager', array( $this, 'dashboard_todo_manager' ) );
        }

        //TODO metabox content
        public function dashboard_todo_manager(){
        ...
        public function todo_files($todo_dirpath=null, $child=false){
            global $todo_file_counter, $todo_instance_counter;
            $todo_last_filename = false;

            if ( is_child_theme() && !$child ){
                $this->todo_files(get_stylesheet_directory(), true);
            }
        ...
        public function admin_sub_menu(){
            ...
            if ( nebula_option('visitors_db') ){
                add_theme_page('Nebula Visitors Data', 'Nebula Visitors Data', 'manage_options', 'nebula_visitors_data', array( $this, 'visitors_data_page' ) ); //Nebula Visitors Data page
            }
        }

        //The Nebula Visitors Data page output
        public function visitors_data_page(){
            global $wpdb;
