		...
		<div class="eleven columns">
			...
			<?php if ( have_posts() ) while ( have_posts() ) : the_post(); ?>
				<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
					...
					<select class="chosen-select" data-placeholder="Select your country...">
						<option value=""></option>
					...
					<select class="chosen-select" multiple data-placeholder="Select categories and taxonomies...">
						<?php $taxonomies = get_object_taxonomies('post'); ?>
						<?php foreach($taxonomies as $tax) : ?>
							<?php
								$terms = get_terms($tax);
								$tax = ( $tax == 'category' ) ? 'Categories' : $tax;
								$tax = ( $tax == 'post_tag' ) ? 'Tags' : $tax;
							?>
							<optgroup label="<?php echo $tax; ?>">
